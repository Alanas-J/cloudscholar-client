    ...
    return (
        <div className={styles.navigationBar+' d-flex flex-column flex-shrink-0  bg-light shadow'}>
            <ul className="nav nav-pills nav-flush flex-column mb-auto text-center ">
                ...
                <button className={((appDisplay === "home") && "active" )+" nav-link my-2 border-bottom rounded-0"} 
                    ...
                    <button className={((appDisplay === "timetable") && "active" )+" nav-link my-2 border-bottom rounded-0"} 
