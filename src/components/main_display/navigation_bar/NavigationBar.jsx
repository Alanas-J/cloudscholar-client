        ...
        <div className={styles.navigationBar+' d-flex flex-column flex-shrink-0  bg-light shadow'}>
            <ul className="nav nav-pills nav-flush flex-column mb-auto text-center ">
                <li className="nav-item my-2">
                    ...
                    onClick={() => dispatch(setDisplay("home"))}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.8rem" height="1.8rem" fill="currentColor" class="bi bi-house-door" viewBox="0 0 16 16">
                    ...
                    onClick={() => dispatch(setDisplay("timetable"))}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.8rem" height="1.8rem" fill="currentColor" class="bi bi-calendar-range" viewBox="0 0 16 16">
            ...
            <div className="dropdown border-top nav-item nav-pills">
                <button onClick={() => dropdownClick(showSettingsDropdown, setShowSettingsDropdown)} className="d-flex pb-4 pt-3 nav-link bg-light align-items-center justify-content-center p-1 link-dark text-decoration-none dropdown-toggle" >
                    <svg xmlns="http://www.w3.org/2000/svg" width="1.8rem" height="1.8rem" fill="#555555" class="bi bi-gear-fill" viewBox="0 0 16 16">
